...
<body style="background-color: #cf9151">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading" align="center">
                        <br><img src="<?php echo base_url();?>images/logo_spp.png" class="img-responsive"
                            alt="Responsive Image" width="100" height="100">
                        <br>
                        <h3 class="panel-title">Selamat datang di Aplikasi Spp</h3>
                    </div>
