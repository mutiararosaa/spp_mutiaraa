...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"> <a><img  src="assets/img/logo_spp.png"></a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.html" class="logo"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->

      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="<?php echo base_url() . 'login' ?>">LOGIN</a></li>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="500">
      ...
      <h2>Aplikasi ini memudahkan pembayaran transaksi di smk igasar pindad</h2>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
            <h3>Sekilas tentang jurusan</h3>
            <!-- <p class="fst-italic">
              Teknik komputer jaringan </p>
            <p class="fst-italic">
              Teknik sepeda motor </p>
            <p class="fst-italic">
              Teknik kendaran ringan </p>
              <p class="fst-italic">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="300">
            <div class="box">
              <span>05</span>
              <h4> Teknik permesinan</h4>
              <p>Teknik Pemesinan merupakan cabang keilmuan yang mempelajari cara memproduksi barang teknik menggunakan mesin. </p>
            </div>
          </div>
    ...
    <section id="cta" class="cta">
      <div class="container" data-aos="zoom-in">
        ...
        <div class="text-center">
          <h3>Visi dan misi</h3>
          <p>Menyamakan persepsi dan arah tujuan sebagai wali kelas dalam rangka mensukseskan pendidikan di lingkungan SMK igasar pindad...</p>
        </div>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <span>Kontak</span>
          <h2>Kontak</h2>
          <p>Kontak smk igasar pindad bandung</p>
        </div>
        ...
        <div class="row" data-aos="fade-up">
          <div class="col-lg-6">
            <div class="info-box mb-4">
              <i class="bx bx-map"></i>
              <h3>Alamat</h3>
              <p>jl.cisaranten kulon no.17,cisaranten kulon,kec.Arcamanik,kota bandyng,jawa barat 40293</p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="info-box  mb-4">
              ...
              <h3>Email</h3>
              <p>smkigasarpindadbandung@gmail.com</p>
            </div>
          </div>
